        ...
        <div >
            ...
            <div className="newsletter-popup mfp-hide">
                <div className="newsletter-content">
                    ...
                    <Typography className="text-light ls-10">Subscribe to the Wolmart market newsletter to
                        receive updates on special offers.</Typography>
                    ...
                    <div className="form-checkbox d-flex align-items-center">
                        ...
                        <label htmlFor="hide-newsletter-popup" className="font-size-sm text-light"> show this popup again.</label>
                    </div>
                </div>
            </div>
